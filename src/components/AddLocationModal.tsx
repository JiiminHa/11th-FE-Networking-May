...
export default function AddLocationModal({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="z-50 relative flex flex-col items-start bg-white rounded-[16px] px-[72px] pt-[32px] pb-[36px] shadow-[4px_4px_4px_3px_rgba(0,0,0,0.25)] gap-[24px] w-[480px]">
        <img
        ...
        <div className="flex items-center gap-4 w-full">
          <img
            src={icon}
            alt="아이콘"
            className="w-[48px] h-[48px] self-center"
          />
          <h2 className="text-2xl font-bold text-[#292E2E] leading-tight">
            {title}
          </h2>
        </div>
